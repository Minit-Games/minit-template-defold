...
// looping with loopcount 0 repeats for as long as the voice is alive.
await writeFile(join(ROOT, 'assets/sound/music.sound'),
  // Baked at the background level rather than played loud and turned down, so
  // the mix is right even if a runtime gain change does not reach a live voice.
  'sound: "/assets/sound/music.wav"\nlooping: 1\ngroup: "music"\ngain: 0.5\npan: 0.0\nspeed: 1.0\nloopcount: 0\n');
